...
- telecodex is the Telegram transport, session controller, and presentation layer.
- Linear is the durable task graph and reviewable execution brief.
- tmux-codex is a local tmux viewer/launcher. Its runner view reflects busy Telecodex sessions; it must not start background runner loops.
